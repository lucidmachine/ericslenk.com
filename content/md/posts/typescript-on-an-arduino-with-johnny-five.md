{:title "TypeScript on an Arduino with Johnny-Five", :date "2019-04-22", :tags ["johnny-five" "arduino" "typescript"], :description "Get some TypeScript running on your Arduino with Johnny-Five!"}
